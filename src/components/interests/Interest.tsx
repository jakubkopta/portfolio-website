...
const Interest = ({name, imagePath, description, position}: Props) => {
    ...
    return (
        ...
        >
            ...
            <span className="font-bold text-[7vw] opacity-80 absolute transform top-1/2 -translate-y-1/2 lg:-rotate-90 group-hover:opacity-100 group-hover:text-5xl group-hover:rotate-0 group-hover:-top-10 ease-in duration-500">
                {name}
            </span>
