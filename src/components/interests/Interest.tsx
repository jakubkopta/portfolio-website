...
const Interest = ({name, imagePath, description, position}: Props) => {
    ...
    return (
        <div
            className="flex flex-col justify-center items-center mt-10 cursor-pointer relative group lg:w-1/3 lg:hover:w-2/3 ease-in duration-500"
        ...
        >
            ...
            <span className="font-bold text-6xl opacity-80 absolute transform top-1/2 -translate-y-1/2 lg:text-8xl lg:-rotate-90 group-hover:opacity-100 group-hover:text-5xl group-hover:rotate-0 group-hover:-top-10 ease-in duration-500">
                {name}
            </span>
