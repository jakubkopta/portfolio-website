    ...
    return (
        <div id="Experience" className="min-h-screen">
            <div className="flex flex-col justify-center items-center">
                ...
                <div className="flex m-5 bg-dark-mode rounded-full border-2 border-black relative">
                    ...
                    <div
                        className="absolute top-0 left-0 w-24 h-10 bg-gray-200 text-dark-mode rounded-full duration-300"
